...
[![GoDoc](https://godoc.org/github.com/4vun1t/bine?status.svg)](https://godoc.org/github.com/4vun1t/bine)
...
See info below, the [API docs](http://godoc.org/github.com/4vun1t/bine), and the [examples](examples). The project is
...
statically in the binary, follow the [embedded package docs](https://godoc.org/github.com/4vun1t/bine/process/embedded)
which will require [building Tor statically](https://github.com/4vun1t/tor-static). Then with
`github.com/4vun1t/bine/process/embedded` imported, change the start line above to:
